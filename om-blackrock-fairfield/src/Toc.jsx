...
const TOC = [
  ...
  { n: 8, label: 'Investment Highlights', sub: true },
  { n: 9, label: 'Property Photos', sub: true },
  { n: 14, label: 'Financial Analysis', section: true },
  { n: 15, label: 'Unit Mix & Rent Roll', sub: true },
  { n: 16, label: 'Income & Expense Analysis', sub: true },
  { n: 17, label: 'Trailing 12-Month Cash Flow', sub: true },
  { n: 18, label: 'Location & Market', section: true },
  { n: 19, label: 'Black Rock, Bridgeport', sub: true },
  { n: 20, label: 'Why Black Rock', sub: true },
  { n: 21, label: 'Fairfield Living, Without the Tax', sub: true },
  { n: 22, label: 'Black Rock Aerials', sub: true },
  { n: 24, label: 'Location & Amenities', sub: true },
  { n: 25, label: 'Bridgeport & Fairfield County', sub: true },
