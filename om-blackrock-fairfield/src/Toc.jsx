...
const TOC = [
  ...
  { n: 6, label: 'Property Overview', sub: true },
  { n: 7, label: 'The Black Rock Trust Building', sub: true },
  { n: 8, label: 'Site Map', sub: true },
  { n: 9, label: 'Property Photos', sub: true },
  { n: 16, label: 'Financial Analysis', section: true },
  { n: 17, label: 'Unit Mix & Rent Roll', sub: true },
  { n: 18, label: 'Income & Expense Analysis', sub: true },
  { n: 19, label: 'Management Transition & T-12', sub: true },
  { n: 20, label: 'Location & Market', section: true },
  { n: 21, label: 'Black Rock, Bridgeport', sub: true },
  { n: 22, label: 'Why Black Rock', sub: true },
  { n: 23, label: 'Fairfield Living, Without the Tax', sub: true },
  { n: 24, label: 'Black Rock Aerials', sub: true },
  { n: 26, label: 'Location & Amenities', sub: true },
  { n: 27, label: 'Drive Times', sub: true },
  { n: 28, label: 'Bridgeport & Fairfield County', sub: true },
  { n: 29, label: 'Regional Positioning', sub: true },
  { n: 30, label: 'The Team', section: true },
  { n: 31, label: 'Team', sub: true },
  { n: 32, label: 'Our Locations', sub: true },
]
