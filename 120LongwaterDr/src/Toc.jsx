...
const TOC = [
  ...
  { n: 8, label: 'Floor Plans', sub: true },
  { n: 10, label: 'Property Photography', sub: true },
  { n: 11, label: 'Financial Analysis', section: true },
  { n: 12, label: 'Rent Roll', sub: true },
  { n: 13, label: 'Tenant Profiles', sub: true },
  { n: 14, label: 'Income & Expense', sub: true },
  { n: 15, label: 'Location & Market', section: true },
  { n: 16, label: 'Norwell Overview', sub: true },
  { n: 17, label: 'Location & Amenities', sub: true },
  { n: 18, label: 'Drive Times', sub: true },
  { n: 19, label: 'Plymouth County Overview', sub: true },
