...
const OUT = process.argv[3] || path.join(__dirname, '300-Main-Street-West-Haven-OM.pdf');
...
const META = {
  title: '300 Main Street, West Haven, CT — 10-Unit Multifamily Offering Memorandum',
  author: 'Northeast Private Client Group',
  subject: 'For Sale · 300 Main Street & 491 Washington Avenue, West Haven, CT 06516 — 10-unit value-add multifamily offering',
  keywords: ['offering memorandum', 'multifamily', 'investment property', 'value-add', 'West Haven CT', 'New Haven County', '300 Main Street', 'Northeast Private Client Group'],
