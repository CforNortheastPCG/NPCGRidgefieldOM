/* ═══════════════════ DEAL CONFIG ═══════════════════
   ...
   This book is the two-building cut of Copps Hill Commons — 107 & 109 Danbury
   Road only (which share a single 1.55-acre parcel and are taxed as one
   property). 103 & 105 are excluded; see om-coppshill-vector for the full
   four-building assemblage book.
...
export const DEAL = {
  ...
  address: '107 & 109 Danbury Road',                             // street line
  ...
  type: '±31,414 SF Mixed-Use · Retail · Office · Residential',  // asset descriptor (cover)
  coverImage: '/photos/cover.jpg',                               // full-bleed cover photo
  pdfName: 'Copps-Hill-Commons-107-109-Danbury-Rd-OM.pdf',       // output filename for the exporter
}
