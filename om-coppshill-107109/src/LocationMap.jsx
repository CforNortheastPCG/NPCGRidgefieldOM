...
export default function LocationMap({ pageNum = 9 }) {
  const FULL_ADDR = '107 & 109 Danbury Road, Ridgefield, CT 06877'
    ...
    <div className="page">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.15fr 1fr', gap: 16, flex: 1, minHeight: 0 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, minHeight: 0, overflow: 'hidden' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, paddingBottom: 8, borderBottom: '1px solid var(--border)' }}>
              ...
              <span style={{ fontSize: 11, fontWeight: 700, color: 'var(--carbon)' }}>Subject Property &mdash; Copps Hill Commons, 107 &amp; 109 Danbury Road</span>
            </div>
      ...
      <div className="page-footer">
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <span className="conf">For Sale &middot; Copps Hill Commons &middot; {FULL_ADDR}</span>
        </div>
