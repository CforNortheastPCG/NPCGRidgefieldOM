...
const TOC = [
  ...
  { n: 4, label: 'The Offering' },
  { n: 5, label: 'Investment Highlights' },
  { n: 6, label: 'The Property', section: true },
  { n: 7, label: 'Property Overview', sub: true },
  { n: 8, label: 'Building Specifications', sub: true },
  { n: 9, label: 'Site Map', sub: true },
  { n: 10, label: 'Site Aerial', sub: true },
  { n: 11, label: 'Building Overviews', sub: true },
  { n: 13, label: 'The Tenants', section: true },
  { n: 14, label: 'Tenant Overview', sub: true },
  { n: 15, label: 'Location & Market', section: true },
  { n: 16, label: 'Ridgefield, Connecticut', sub: true },
  { n: 17, label: 'Location & Amenities', sub: true },
  { n: 18, label: 'Aerial Maps', sub: true },
  { n: 20, label: 'Drive Times', sub: true },
  { n: 21, label: 'Demographics', sub: true },
  { n: 22, label: 'Regional Map', sub: true },
  { n: 23, label: 'The Team', section: true },
  { n: 24, label: 'Our Team', sub: true },
