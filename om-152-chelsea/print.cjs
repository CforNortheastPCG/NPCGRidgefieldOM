...
// Write listing/broker info into the PDF's document metadata so anyone — or any
// AI tool — ingesting the file is pointed at the exclusive listing brokers.
// Kept from the raster pipeline: even with selectable vector text, the
// Title/Author/Subject/Keywords are what indexers and readers surface first.
