...
function declutter(pois, anchor) {
  const MIN = 0.0011 // ~120 m collision radius — halved for zoom 14; East Boston's
                     // Maverick Sq cluster sits within a few blocks, and the old
                     // zoom-13 radius (~265 m) spiraled those pins visibly off-site
...
function buildStaticMapUrl() {
  ...
  const params = [
    // Center and the subject pin sit on the property's coords. East Boston's
    // amenities cluster within ~a mile (Maverick Sq → Eagle Hill → Day Sq) with
    // Constitution Beach the far outlier east, so zoom 14 fills the frame with
    // the neighborhood while keeping every pin on-frame.
    ...
    <div className="page">
      ...
      <div className="section--tight" style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
        ...
        <div style={{ fontSize: 11, lineHeight: 1.55, color: 'var(--graphite)', marginBottom: 12 }}>
          152&ndash;154 Chelsea Street sits between Maverick Square and Day Square, in the middle of East
          Boston&rsquo;s everyday life &mdash; Santarpio&rsquo;s Pizza two blocks down the street, Maverick
          Square&rsquo;s shops and bakeries, and Shaw&rsquo;s at Liberty Plaza all within a short walk. The Blue
          Line&rsquo;s Maverick and Airport stations are each about a half-mile out, the East Boston Neighborhood
          Health Center anchors Gove Street, and the Mary Ellen Welch Greenway, Piers Park, and Bremen Street
          Community Park thread green space through the neighborhood to the harborfront.
        </div>
