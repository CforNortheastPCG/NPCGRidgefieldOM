...
const TOC = [
  ...
  { n: 14, label: 'East Boston Overview', sub: true },
  { n: 15, label: 'Location & Amenities', sub: true },
  { n: 16, label: 'Drive Times', sub: true },
  { n: 17, label: 'Boston Overview', sub: true },
      ...
      <div className="section--tight" style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: 28, flex: 1, minHeight: 0 }}>
          ...
          <div style={{ borderRadius: 4, overflow: 'hidden', position: 'relative' }}>
            <img src="/photos/skyline-3.jpg" alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
