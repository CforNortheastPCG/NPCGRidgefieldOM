/* Drive-time ring generator for Salem Square — "radial envelope" method.
...
const SUBJECT = { lat: 41.4705, lon: -73.0490 } // 628 New Haven Road, Naugatuck CT
const CONTOURS = [
...
const res = await fetch(`${VALHALLA}?json=${encodeURIComponent(JSON.stringify(body))}`, { headers: { 'User-Agent': 'npcg-om-salem/1.0' } })
...
const file = `/* AUTO-GENERATED by scripts/gen-isochrones.mjs (radial-envelope method) —
   do not hand-edit. Organic-but-clean drive-time rings from 628 New Haven Road,
   Naugatuck: raw Valhalla isochrone polygons (costing auto) resolved to one
