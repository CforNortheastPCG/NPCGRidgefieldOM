...
const CITIES = [
  ...
  { name: 'Torrington', drive: '~22 mi · 35 min' },
  { name: 'New Haven', drive: '~18 mi · 30 min' },
  { name: 'Bridgeport', drive: '~22 mi · 35 min' },
  { name: 'Danbury', drive: '~28 mi · 40 min' },
  { name: 'Hartford', drive: '~33 mi · 45 min' },
]
    ...
    <div className="page">
      ...
      <div className="section--tight" style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
        ...
        <div style={{ fontSize: 11.5, lineHeight: 1.5, color: 'var(--graphite)', marginBottom: 10 }}>
          <strong>Road-network drive-time reach from the property.</strong> Route 8, reached directly off New Haven
          Road, puts Waterbury inside ~15 minutes and New Haven, Bridgeport, Danbury, and Hartford inside ~45,
          drawing on a deep Naugatuck Valley, Greater Waterbury, and New Haven labor and tenant pool.
        </div>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '4px 16px', marginBottom: 10, paddingBottom: 8, borderBottom: '1px solid var(--border)' }}>
          <LegendRow color="#F8971D" label="Salem Square (subject)" pin />
