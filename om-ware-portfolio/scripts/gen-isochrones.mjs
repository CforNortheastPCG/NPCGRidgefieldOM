/* Drive-time ring generator for the Ware Portfolio — "radial envelope" method.
...
const SUBJECT = { lat: 42.2616, lon: -72.2420 } // downtown Ware portfolio (North/Parker St)
const CONTOURS = [
...
const res = await fetch(`${VALHALLA}?json=${encodeURIComponent(JSON.stringify(body))}`, { headers: { 'User-Agent': 'npcg-om-ware/1.0' } })
...
const file = `/* AUTO-GENERATED by scripts/gen-isochrones.mjs (radial-envelope method) —
   do not hand-edit. Organic-but-clean drive-time rings from the Ware Portfolio
   (downtown Ware, MA): raw Valhalla isochrone polygons (costing auto) resolved
   to one radius per bearing, despiked and lightly smoothed, as [lat,lng] arrays.
