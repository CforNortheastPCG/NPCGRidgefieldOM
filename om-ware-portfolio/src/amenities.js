/* ═══════════════════ AREA AMENITIES DATA ═══════════════════
   ...
   Area Amenities directory page. Hand-curated for the 590–608 Campbell
   Avenue (West Haven) offering. Distances are approximate from the property.
...
export const PROPERTY = {
  lat: 41.274083, // per Phase I ESA site coordinates
  lng: -72.951075,
  address: '590–608 Campbell Avenue, West Haven, CT 06516',
}

/* Connectivity facts shown on the map page (consistent with the OM body). */
export const CONNECTIVITY = [
  { label: 'Metro-North', value: 'West Haven Station (~1 mi)' },
  { label: 'VA Medical Campus', value: '950 Campbell Ave (~1 mi)' },
...
export const DIRECTORY = [
  {
    ...
    items: [
      { name: "Zuppardi's Apizza", note: '179 Union Ave · Famous New Haven apizza · ~0.4 mi', address: "Zuppardi's Apizza, 179 Union Ave, West Haven, CT 06516" },
      ...
      { name: 'The Breakwall', note: '305 Captain Thomas Blvd · Shoreline pub & grill', address: 'The Breakwall, 305 Captain Thomas Blvd, West Haven, CT 06516' },
      { name: 'Saray Turkish Restaurant', note: '770 Campbell Ave · Acclaimed Turkish cuisine', address: 'Saray Turkish Restaurant, 770 Campbell Ave, West Haven, CT 06516' },
      { name: "Georgie's Diner", note: '427 Elm St · Landmark diner', address: "Georgie's Diner, 427 Elm St, West Haven, CT 06516" },
    ],
  },
  {
  ...
  },
  {
    heading: 'Healthcare',
    items: [
      { name: 'VA Connecticut Healthcare', note: '950 Campbell Ave · Up the same avenue · ~1 mi', address: 'VA Connecticut Healthcare System, 950 Campbell Ave, West Haven, CT 06516' },
  ...
  },
  {
    ...
    items: [
      { name: 'West Haven Station', note: '20 Railroad Ave · Metro-North New Haven Line → GCT · ~1 mi', address: 'West Haven Station, 20 Railroad Ave, West Haven, CT 06516' },
...
const COORDS = {
  ...
  'The Breakwall, 305 Captain Thomas Blvd, West Haven, CT 06516': [41.259469, -72.949195],
