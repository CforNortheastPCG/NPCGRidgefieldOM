...
const SUBJECT = { lat: 41.274083, lng: -72.951075 }
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 11, minHeight: 0, overflow: 'hidden' }}>
            ...
            <div style={{ flex: 1, minHeight: 0 }}>
              ...
              <div style={{ fontSize: 10, lineHeight: 1.45, color: 'var(--graphite)' }}>
                ...
                employer &mdash; alongside a fast-growing <strong>life-sciences</strong> cluster (Alexion,
                Arvinas, BioHaven). The <strong>University of New Haven</strong> and the <strong>VA
                Connecticut</strong> campus are minutes away, with aerospace &amp; defense and the Hartford
                insurance corridor rounding out a deep, diversified regional economy.
              </div>
            </div>
          </div>
        </div>
