...
// Subject property — Cottage Lane Multifamily, Concord MA.
const SUBJECT = { lat: 42.45835, lng: -71.35350 }
...
const COMMUTE = [
  { label: 'Cambridge / Kendall Sq', value: '~17 mi · ~30 min' },
  { label: 'Downtown Boston', value: '~20 mi · ~35 min' },
  { label: 'Logan Intl (BOS)', value: '~25 mi · ~45 min' },
  { label: 'Worcester', value: '~35 mi · ~45 min' },
  { label: 'Manchester, NH', value: '~45 mi · ~50 min' },
  { label: 'Providence, RI', value: '~70 mi · ~1.5 hr' },
  { label: 'New York City', value: '~210 mi · ~3.5 hr' },
]
    ...
    <div className="page">
      ...
      <div className="section--tight" style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
        ...
        <div style={{ fontSize: 11.5, lineHeight: 1.55, color: 'var(--graphite)', marginBottom: 10 }}>
          <strong>At the heart of historic Concord, 20 miles northwest of Boston.</strong>{' '}
          Cottage Lane sits steps from Concord Center and the MBTA Fitchburg Line, with Route 2 and I-95 / Route 128
          placing Cambridge, Boston, and the region&rsquo;s tech and life-science corridor within an easy commute.
          Concord pairs small-town prestige and top-ranked schools with direct rail and highway access to one of the
          nation&rsquo;s strongest, most supply-constrained job and housing markets.
        </div>

        {/* Regional stat strip — golden-top boxes matching the Exec Summary house style */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12, marginBottom: 12 }}>
          {[
            ['~20 mi', 'To downtown Boston'],
            ['MBTA Rail', 'Fitchburg Line at Concord'],
            ['~20 min', 'To Route 128 / I-95'],
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 9, minHeight: 0, overflow: 'hidden' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 10, lineHeight: 1.45, color: 'var(--graphite)' }}>
                <strong>Route 2</strong> — the main east-west arterial, direct to Cambridge and Boston (~30&ndash;40
                min) and west toward I-495. <strong>Route 128 / I-95</strong> — the region&rsquo;s tech and life-science
                ring, ~20 minutes east. <strong>MBTA Fitchburg Line</strong> — Concord depot, one-seat rail to Porter
                Square (Cambridge) and North Station (Boston).
              </div>
            </div>
            <div style={{ flex: 1, minHeight: 0 }}>
              ...
              <div style={{ fontSize: 9.4, lineHeight: 1.42, color: 'var(--graphite)' }}>
                Concord anchors Boston&rsquo;s affluent western suburbs and feeds the region&rsquo;s knowledge economy.
                Locally, <strong>Emerson Hospital</strong> and the top-ranked Concord schools employ thousands; the{' '}
                <strong>Route 128 / I-95 corridor</strong> (Raytheon, MathWorks, MIT Lincoln Laboratory) sits ~20
                minutes east; and the Fitchburg Line links residents to <strong>Cambridge&rsquo;s Kendall Square</strong>{' '}
                biotech cluster, <strong>Harvard</strong> and <strong>MIT</strong>, and downtown Boston&rsquo;s
                financial and consulting core.
              </div>
            </div>
          </div>
        </div>
