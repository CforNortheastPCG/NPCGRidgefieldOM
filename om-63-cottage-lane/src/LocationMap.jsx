...
function buildStaticMapUrl() {
  ...
  const params = [
    // Center and the subject pin sit on the property's coords. Concord's amenities
    // cluster tightly in the walkable town center with a few outliers (Walden Pond,
    // West Concord, Emerson Hospital), so zoom 13 keeps the whole town on-frame.
    ...
    <div className="page">
      ...
      <div className="section--tight" style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
        ...
        <div style={{ fontSize: 11, lineHeight: 1.55, color: 'var(--graphite)', marginBottom: 12 }}>
          Cottage Lane sits a short walk from Concord Center, where the town&rsquo;s dining, cafés, and daily needs
          concentrate &mdash; 80 Thoreau, Caffè Nero, Main Streets Market, Concord Free Public Library, and CVS among
          them. The MBTA Concord station on the Fitchburg Line is roughly a quarter-mile away, with direct commuter-rail
          service to Cambridge (Porter) and North Station, Boston. Walden Pond, the Old North Bridge, and Minute Man
          National Historical Park ring the town, and Emerson Hospital and the top-ranked Concord schools anchor the
