...
const TOC = [
  ...
  { n: 7, label: 'Site Plan', sub: true },
  { n: 9, label: 'Building Specifications', sub: true },
  { n: 10, label: 'Building Overviews', sub: true },
  { n: 17, label: 'Residential Interiors', sub: true },
  { n: 18, label: 'The Tenants', section: true },
  { n: 19, label: 'Tenant Overview', sub: true },
  { n: 23, label: 'Location & Market', section: true },
  { n: 24, label: 'Local & Aerial Maps', sub: true },
  { n: 27, label: 'Drive Times', sub: true },
  { n: 28, label: 'Regional Map', sub: true },
  { n: 29, label: 'Ridgefield Market & Amenities', sub: true },
  { n: 33, label: 'Demographics', sub: true },
  { n: 35, label: 'The Team', section: true },
  { n: 36, label: 'Our Team', sub: true },
  { n: 37, label: 'Our Locations', sub: true },
]
