...
const SUBJECT = { lat: 41.1143093, lng: -73.4167832 } // 6 Elm Street, Norwalk CT
...
const CENTER = { lat: 41.18, lng: -73.33 }
const ZOOM = 8, W = 640, H = 312

const CITIES = [
  { name: 'Stamford', drive: '~9 mi · 15 min' },
  { name: 'Bridgeport', drive: '~15 mi · 20 min' },
  { name: 'White Plains', drive: '~24 mi · 32 min' },
  { name: 'Danbury', drive: '~23 mi · 34 min' },
  { name: 'New Haven', drive: '~34 mi · 40 min' },
  { name: 'New York City', drive: '~54 mi · 65 min' },
]
    ...
    <div className="page">
      ...
      <div className="section--tight" style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
        ...
        <div style={{ fontSize: 11.5, lineHeight: 1.5, color: 'var(--graphite)', marginBottom: 10 }}>
          <strong>Road-network drive-time reach from the property.</strong> I-95, the Merritt Parkway, and Route 7
          put Stamford and Bridgeport inside ~20 minutes and midtown Manhattan inside about an hour, while
          Metro-North&rsquo;s New Haven Line runs express to Grand Central &mdash; drawing on a deep Fairfield
          County and NYC-commuter tenant pool.
        </div>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '4px 16px', marginBottom: 10, paddingBottom: 8, borderBottom: '1px solid var(--border)' }}>
          <LegendRow color="#F8971D" label="6 Elm Street (subject)" pin />
        ...
        {/* MAP — layered: base → bands → labels overlay → subject marker.
        ...
        <div style={{ position: 'relative', height: '100%', aspectRatio: `${W} / ${H}`, maxWidth: '100%', borderRadius: 4, overflow: 'hidden', border: '1px solid var(--border)' }}>
          {ok ? (
            <>
              <img src={baseUrl} alt="Drive-time map centered on 6 Elm Street, Norwalk CT" style={{ ...fill, objectFit: 'fill', display: 'block' }} />
