...
const TOC = [
  ...
  { n: 7, label: 'Capex Summary', sub: true },
  { n: 8, label: 'Property Photography', sub: true },
  { n: 18, label: 'Financial Analysis', section: true },
  { n: 19, label: 'Unit Mix & Rent Roll', sub: true },
  { n: 20, label: 'Income & Expense', sub: true },
  { n: 21, label: 'Location & Market', section: true },
  { n: 22, label: 'Norwalk', sub: true },
  { n: 23, label: 'Location & Amenities', sub: true },
  { n: 24, label: 'Fairfield County', sub: true },
  { n: 25, label: 'Regional Positioning', sub: true },
  { n: 26, label: 'The Team', section: true },
  { n: 27, label: 'Your Advisor', sub: true },
