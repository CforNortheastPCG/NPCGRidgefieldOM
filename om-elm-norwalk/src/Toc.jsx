...
const TOC = [
  ...
  { n: 7, label: 'Building Overview', sub: true },
  { n: 8, label: 'Capex Summary', sub: true },
  { n: 9, label: 'Property Photography', sub: true },
  { n: 15, label: 'Financial Analysis', section: true },
  { n: 16, label: 'Unit Mix & Rent Roll', sub: true },
  { n: 17, label: 'Income & Expense', sub: true },
  { n: 18, label: 'Location & Market', section: true },
  { n: 19, label: 'Norwalk', sub: true },
  { n: 20, label: 'Location & Amenities', sub: true },
  { n: 21, label: 'Fairfield County', sub: true },
  { n: 22, label: 'Regional Positioning', sub: true },
  { n: 23, label: 'The Team', section: true },
  { n: 24, label: 'Your Advisor', sub: true },
  { n: 25, label: 'Team', sub: true },
  { n: 26, label: 'Our Locations', sub: true },
]
      ...
      <div className="section--tight" style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: 28, flex: 1, minHeight: 0 }}>
          ...
          <div style={{ borderRadius: 4, overflow: 'hidden', position: 'relative' }}>
            <img src="/photos/53-web-or-mls-6 Elm St, Norwalk, CT 06850 (52 OF 53).JPG" alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
