/* ═══════════════════ POST /api/lead ═══════════════════
   ...
   Env vars (Pages project → Settings → Variables and Secrets):
     ...
     LEAD_NOTIFY_TO   var      — where leads go (default: propdata2@gmail.com)
...
const DEFAULT_FROM_NAME = 'Salem Square OM'
const DEFAULT_NOTIFY = 'cformica@northeastpcg.com'
...
export async function onRequestPost({ request, env }) {
  ...
  const deal = String(body.deal || 'Salem Square').trim().slice(0, 200)
