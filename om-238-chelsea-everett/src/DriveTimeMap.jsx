...
const SUBJECT = { lat: 42.40150, lng: -71.05250 } // 238 Chelsea St, Everett MA
const CENTER = { lat: 42.39, lng: -71.18 }            // centered on the 60-min band reach
const ZOOM = 8, W = 640, H = 460

const CITIES = [
  { name: 'Encore Casino', drive: '~2 mi · 8 min' },
  { name: 'Assembly Row', drive: '~2 mi · 8 min' },
  { name: 'Downtown Boston', drive: '~4 mi · 15 min' },
  { name: 'Cambridge', drive: '~5 mi · 15 min' },
  { name: 'Logan (BOS)', drive: '~5 mi · 15 min' },
  { name: 'Lynn', drive: '~6 mi · 18 min' },
]
    ...
    <div className="page">
      ...
      <div className="section--tight" style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
        ...
        <div style={{ fontSize: 11.5, lineHeight: 1.5, color: 'var(--graphite)', marginBottom: 10 }}>
          <strong>Road-network and transit reach from the property.</strong> Route 1 and the Tobin Bridge put downtown
          Boston and Logan Airport within ~15 minutes, with MBTA Orange Line service at Wellington and Assembly
          connecting the property to the regional rapid-transit network — drawing on one of the deepest labor and tenant
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '4px 16px', marginBottom: 10, paddingBottom: 8, borderBottom: '1px solid var(--border)' }}>
          <LegendRow color="#F8971D" label="Chelsea Street Apartments (subject)" pin />
        ...
        <div style={{ position: 'relative', borderRadius: 4, overflow: 'hidden', border: '1px solid var(--border)', flex: 1, minHeight: 0 }}>
          {ok ? (
            <>
              <img src={baseUrl} alt="Drive-time map centered on Chelsea Street Apartments, Everett MA" style={{ ...fill, objectFit: 'fill', display: 'block' }} />
