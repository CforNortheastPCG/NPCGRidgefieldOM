...
import { SectionTitle, KpiStrip, SourceNote } from '../components/Blocks.jsx'
import { IconDisc } from '../components/Icons.jsx'
import { PROVEN_PERFORMANCE } from '../data/firm.js'
...
export default function ProvenPerformancePage({ pageNum }) {
