...
import { SectionTitle, BlockLabel, Callout } from '../Blocks.tsx'
import { BulletList } from '../Pitch.tsx'
import { TAX_DEFERRAL } from '../../data/advisory.ts'
...
export default function TaxDeferralPage({ pageNum }: { pageNum?: number }) {
