...
import { LEADERSHIP, SENIOR_INVESTMENT_SALES, INVESTMENT_SALES } from '../../data/firm.ts'
...
function BigCard({ member }: { member: TeamMember }) {
  return (
