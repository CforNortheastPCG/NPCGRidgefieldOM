/* ═══════════════════ TABLE CELL KIT ═══════════════════
   Plain values, deliberately NOT in Blocks.jsx — a module that mixes
   component and non-component exports breaks React Fast Refresh (and the
...
export const DENSE = { padding: '1.6px 7px', lineHeight: 1.15 }

export const zebra = i => (i % 2 === 1 ? { background: 'var(--linen)' } : undefined)
// Em dash for a figure the source genuinely does not report — never print $0.
export const DASH = '—'
export const orDash = (v, fmt) => (v == null ? DASH : fmt(v))
