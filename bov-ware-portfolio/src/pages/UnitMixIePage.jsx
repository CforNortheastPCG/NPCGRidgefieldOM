...
export default function UnitMixIePage({ pageNum }) {
  ...
  const noiBg = { background: 'var(--golden)', color: '#fff', fontWeight: 800, fontSize: 8.3, padding: '4px 7px', textAlign: 'right' }
  ...
  return (
    <div className="page">
      ...
      <div className="section--tight" style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        <div className="section-title" style={{ marginBottom: 2, fontSize: 15.8 }}>Unit Mix &amp; <span style={{ color: '#F8971D' }}>Income Analysis</span></div>
