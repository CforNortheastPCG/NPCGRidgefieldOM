        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 28, flex: 1, minHeight: 0 }}>
          <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
            ...
            <p style={{ fontSize: 11.9, lineHeight: 1.5, marginBottom: 10 }}>
              Northeast Private Client Group is pleased to present <strong>South End Plaza</strong>, a 19-unit
              mixed-use retail and apartment property at {ADDR} in Thomaston, Connecticut, offered at $2,450,000.
              Built in 1971, the two-story building totals about 14,614 square feet on a 0.77-acre parcel, with nine
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, minHeight: 0 }}>
            <div className="bldg-card" style={{ padding: '12px 14px', flex: 3, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                ...
                <div className="bldg-row"><span className="bldg-label">Total Units</span><span className="bldg-val">19 (10 residential · 9 commercial)</span></div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, minHeight: 0 }}>
            ...
            <div className="bldg-card" style={{ padding: '12px 14px', flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                ...
                <div className="bldg-row"><span className="bldg-label">Commercial</span><span className="bldg-val">9 suites · 5,973 SF</span></div>
        ...
        <table className="data-table" style={{ fontSize: 11 }}>
          ...
          <tbody>
            ...
            <tr className="total-row">
              ...
              <td style={{ textAlign: 'center' }}><strong>19 units</strong></td>
    ...
    <div className="page">
      ...
      <div className="section--tight" style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: 8, tableLayout: 'fixed' }}>
          ...
          <tbody>
            {[
              ['Residential Scheduled Rent', '$175,800', '$9,253', '$196,800', '$10,358', false],
              ['Commercial Scheduled Rent', '$84,900', '$4,468', '$106,278', '$5,594', false],
              ['Gross Scheduled Rent', '$260,700', '$13,721', '$303,078', '$15,952', true],
              ['Vacancy & Collections Loss', '-$8,790', '-$463', '-$15,154', '-$798', false],
              ['Effective Rental Income', '$251,910', '$13,258', '$287,924', '$15,154', true],
              ['CAM Reimbursement (Water/Sewer)', '$12,822', '$675', '$16,905', '$890', false],
              ['Other Income (fees, pet, etc.)', '$6,068', '$319', '$6,068', '$319', false],
            ].map(([label, ...cells]) => {
            ...
            <tr><td style={{ ...totBg, textAlign: 'left' }}>Effective Gross Income</td><td style={totBg}>$270,800</td><td style={totBg}>$14,253</td><td style={totBg}>$310,897</td><td style={totBg}>$16,363</td></tr>
          </tbody>
        </table>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: 4, tableLayout: 'fixed' }}>
          ...
          <tbody>
            {[
              ['Real Estate Taxes', '$30,719', '$1,617', '$30,719', '$1,617'],
              ['Property Management (5% of EGI)', '$13,540', '$713', '$15,545', '$818'],
              ['Property Insurance', '$14,375', '$757', '$14,375', '$757'],
              ['Water & Sewer', '$28,175', '$1,483', '$28,175', '$1,483'],
              ['Electric (Common)', '$3,064', '$161', '$3,064', '$161'],
              ['Trash Removal', '$7,060', '$372', '$7,060', '$372'],
              ['Repairs & Maintenance', '$7,307', '$385', '$7,307', '$385'],
              ['Landscaping / Snow', '$8,160', '$429', '$8,160', '$429'],
            ].map(([label, ...cells], i) => (
            ...
            <tr><td style={{ ...totBg, textAlign: 'left' }}>Total Expenses</td><td style={totBg}>$112,401</td><td style={totBg}>$5,916</td><td style={totBg}>$114,406</td><td style={totBg}>$6,021</td></tr>
  ...
  const boxes = [
    {
      ...
      items: [
        ...
        { head: 'Diversified Residential and Commercial Income', body: 'Ten apartments and nine commercial suites split the rent roll between residential and retail demand, both below market, in one 19-unit building on 0.77 acres.' },
