...
const TOC = [
  ...
  { n: 27, label: 'Downtown Aerials', sub: true },
  { n: 29, label: 'Location & Amenities', sub: true },
  { n: 30, label: 'Fairfield County', sub: true },
  { n: 31, label: 'Regional Positioning', sub: true },
  { n: 32, label: 'The Team', section: true },
