...
const TOC = [
  ...
  { n: 9, label: 'Building A — Photos & Floor Plan', sub: true },
  { n: 14, label: 'Building B — Exterior, Photos & Floor Plan', sub: true },
  { n: 18, label: 'Building C — Exterior, Photos & Floor Plan', sub: true },
  { n: 22, label: 'Financial Analysis', section: true },
  { n: 23, label: 'Unit Mix & Rent Roll', sub: true },
  { n: 24, label: 'Income & Expense', sub: true },
  { n: 25, label: 'Location & Market', section: true },
  { n: 26, label: 'Ridgefield', sub: true },
  { n: 27, label: 'Location & Amenities', sub: true },
  { n: 28, label: 'Fairfield County', sub: true },
  { n: 29, label: 'Regional Positioning', sub: true },
  { n: 30, label: 'The Team', section: true },
  { n: 31, label: 'Your Advisor', sub: true },
  { n: 32, label: 'Team', sub: true },
  { n: 33, label: 'Our Locations', sub: true },
]
