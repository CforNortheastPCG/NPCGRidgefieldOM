...
const TOC = [
  ...
  { n: 14, label: 'Buildings B & C — Exteriors', sub: true },
  { n: 15, label: 'Building B — Photos & Floor Plan', sub: true },
  { n: 18, label: 'Building C — Photos & Floor Plan', sub: true },
  { n: 21, label: 'Financial Analysis', section: true },
  { n: 22, label: 'Unit Mix & Rent Roll', sub: true },
  { n: 23, label: 'Income & Expense', sub: true },
  { n: 24, label: 'Location & Market', section: true },
  { n: 25, label: 'Ridgefield', sub: true },
  { n: 26, label: 'Location & Amenities', sub: true },
  { n: 27, label: 'Fairfield County', sub: true },
  { n: 28, label: 'Regional Positioning', sub: true },
  { n: 29, label: 'The Team', section: true },
  { n: 30, label: 'Your Advisor', sub: true },
