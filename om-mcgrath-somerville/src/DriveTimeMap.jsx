...
const SUBJECT = { lat: 42.38605, lng: -71.09175 } // 416-422 McGrath Hwy, Somerville MA
const CENTER = { lat: 42.37, lng: -71.20 }            // centered on the 60-min band reach
const ZOOM = 8, W = 640, H = 460

const CITIES = [
  { name: 'Downtown Boston', drive: '~2 mi · 10 min' },
  { name: 'Cambridge', drive: '~3 mi · 10 min' },
  { name: 'Logan (BOS)', drive: '~5 mi · 15 min' },
  { name: 'Medford', drive: '~3 mi · 12 min' },
  { name: 'Newton', drive: '~8 mi · 20 min' },
  { name: 'Quincy', drive: '~10 mi · 25 min' },
]
    ...
    <div className="page">
      ...
      <div className="section--tight" style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
        ...
        <div style={{ fontSize: 11.5, lineHeight: 1.5, color: 'var(--graphite)', marginBottom: 10 }}>
          <strong>Road-network and transit reach from the property.</strong> McGrath Highway and I-93 put downtown
          Boston and Cambridge within ~10 minutes and Logan Airport within ~15, while four MBTA rapid-transit stations
          connect the property to the regional network — drawing on one of the deepest labor and tenant pools in the
          country.
        </div>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '4px 16px', marginBottom: 10, paddingBottom: 8, borderBottom: '1px solid var(--border)' }}>
          <LegendRow color="#F8971D" label="McGrath Apartments (subject)" pin />
        ...
        <div style={{ position: 'relative', borderRadius: 4, overflow: 'hidden', border: '1px solid var(--border)', flex: 1, minHeight: 0 }}>
          {ok ? (
            <>
              <img src={baseUrl} alt="Drive-time map centered on McGrath Apartments, Somerville MA" style={{ ...fill, objectFit: 'fill', display: 'block' }} />
