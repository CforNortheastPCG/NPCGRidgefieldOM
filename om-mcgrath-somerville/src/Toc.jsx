...
const TOC = [
  ...
  { n: 8, label: 'Property Photography', sub: true },
  { n: 11, label: 'Financial Analysis', section: true },
  { n: 12, label: 'Rent Roll', sub: true },
  { n: 13, label: 'Income & Expense', sub: true },
  { n: 14, label: 'Underwriting Notes', sub: true },
  { n: 15, label: 'Location & Market', section: true },
  { n: 16, label: 'Somerville Overview', sub: true },
  { n: 17, label: 'Location & Amenities', sub: true },
  { n: 18, label: 'Local Attractions', sub: true },
  { n: 20, label: 'Drive Times', sub: true },
  { n: 21, label: 'Greater Boston Overview', sub: true },
  { n: 22, label: 'Regional Positioning', sub: true },
  { n: 23, label: 'The Team', section: true },
  { n: 24, label: 'Team', sub: true },
  { n: 25, label: 'Our Locations', sub: true },
]
    ...
    <div className="page">
      ...
      <div className="section--tight" style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: 28, flex: 1, minHeight: 0 }}>
          ...
          {/* Accent photo — a neighborhood aerial. Deliberately NOT the cover
              image, which would repeat the cover hero one page earlier. */}
          <div style={{ borderRadius: 4, overflow: 'hidden', position: 'relative' }}>
            <img src="/photos/aerial-2.jpg" alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
