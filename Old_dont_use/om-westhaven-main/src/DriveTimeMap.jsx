...
const SUBJECT = { lat: 41.272764, lng: -72.947864 } // 300 Main Street, West Haven CT
const CENTER = { lat: 41.46, lng: -72.78 }
const ZOOM = 8, W = 640, H = 312 // wide-short frame matched to the map slot

const CITIES = [
  { name: 'New Haven', drive: '~4 mi · 10 min' },
  { name: 'Milford', drive: '~8 mi · 13 min' },
  { name: 'Bridgeport', drive: '~16 mi · 22 min' },
  { name: 'Hartford', drive: '~40 mi · 45 min' },
  { name: 'Stamford', drive: '~42 mi · 50 min' },
  { name: 'New York City', drive: '~75 mi · 1h 40m' },
]
    ...
    <div className="page">
      ...
      <div className="section--tight" style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
        ...
        <div style={{ fontSize: 11.5, lineHeight: 1.5, color: 'var(--graphite)', marginBottom: 10 }}>
          <strong>Road-network drive-time reach from the property.</strong> I-95 and I-91 meet at New Haven just
          minutes away &mdash; opening the Bridgeport and Stamford corridor to the southwest and the
          Hartford&ndash;Springfield corridor to the north &mdash; while the Metro-North New Haven Line runs from the
          West Haven station toward Grand Central, drawing on a deep New Haven and Fairfield County commuter pool.
        </div>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '4px 16px', marginBottom: 10, paddingBottom: 8, borderBottom: '1px solid var(--border)' }}>
          <LegendRow color="#F8971D" label="300 Main Street (subject)" pin />
        ...
        {/* MAP — layered: base → rings → labels overlay → subject marker.
            ...
            stays to-scale — no Mercator distortion. */}
        ...
        <div style={{ position: 'relative', height: '100%', aspectRatio: `${W} / ${H}`, maxWidth: '100%', borderRadius: 4, overflow: 'hidden', border: '1px solid var(--border)' }}>
          {ok ? (
            <>
              <img src={baseUrl} alt="Drive-time map centered on West Haven, CT" style={{ ...fill, objectFit: 'fill', display: 'block' }} />
