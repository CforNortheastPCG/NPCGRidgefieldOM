...
export default function LocationMap({ pageNum = 9 }) {
  const FULL_ADDR = '300 Main Street, West Haven, CT 06516'
    ...
    <div className="page">
      ...
      <div className="section--tight" style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
        ...
        <div style={{ fontSize: 11.5, lineHeight: 1.6, color: 'var(--graphite)', marginBottom: 12 }}>
          Positioned on a prominent corner in West Haven&rsquo;s Allingtown neighborhood, the property sits minutes
          from the University of New Haven, the VA Connecticut medical campus, the West Haven Metro-North station,
          and the Savin Rock shoreline &mdash; with quick I-95 access to downtown New Haven and Yale.
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.15fr 1fr', gap: 16, flex: 1, minHeight: 0 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14, minHeight: 0, overflow: 'hidden' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 9, paddingBottom: 10, borderBottom: '1px solid var(--border)' }}>
              ...
              <span style={{ fontSize: 13, fontWeight: 700, color: 'var(--carbon)' }}>Subject Property &mdash; 300 Main Street</span>
            </div>
