    ...
    <div className="page">
      <div className="cover-hero">
        ...
        <div className="cover-hero-overlay">
          ...
          <div className="cover-hero-name">300 Main Street</div>
          <div className="cover-hero-sub">West Haven, Connecticut</div>
          <div className="cover-hero-rule" />
          <div className="cover-hero-prep">10-Unit Multifamily · Value-Add Offering</div>
        </div>
      </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 28, flex: 1, minHeight: 0 }}>
          <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 12 }}>
              <div style={{ textAlign: 'center', padding: '6px 4px', borderTop: '3px solid var(--golden)' }}>
                <div style={{ fontSize: 18, fontWeight: 800, color: 'var(--carbon)', lineHeight: 1 }}>$1,400,000</div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6, minHeight: 0 }}>
            <div style={{ flex: 1, borderRadius: 3, overflow: 'hidden', minHeight: 0 }}>
              <img src="/photos/main/main-6.jpg" alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
            </div>
            <div style={{ flex: 1, borderRadius: 3, overflow: 'hidden', minHeight: 0 }}>
              <img src="/photos/main/main-2.jpg" alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
            </div>
          </div>
        </div>
      </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, flex: 1, minHeight: 0 }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, minHeight: 0 }}>
            <div className="bldg-card" style={{ padding: '12px 14px', flex: 3, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                <div className="bldg-row"><span className="bldg-label">Address</span><span className="bldg-val">300 Main St &amp; 491 Washington Ave</span></div>
                ...
                <div className="bldg-row"><span className="bldg-label">Total Units</span><span className="bldg-val">10 (All 1BR) + 1 Room</span></div>
                <div className="bldg-row"><span className="bldg-label">Buildings</span><span className="bldg-val">2 (Attached)</span></div>
                <div className="bldg-row"><span className="bldg-label">Lot Size</span><span className="bldg-val">0.21 Acres</span></div>
                <div className="bldg-row"><span className="bldg-label">Building SF</span><span className="bldg-val">8,801 SF</span></div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, minHeight: 0 }}>
            <div className="bldg-card" style={{ padding: '12px 14px', flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                <div className="bldg-row"><span className="bldg-label">Style</span><span className="bldg-val">Tudor &middot; Stucco on Wood Frame</span></div>
                <div className="bldg-row"><span className="bldg-label">Stories</span><span className="bldg-val">2.25 + Finished Attic</span></div>
                <div className="bldg-row"><span className="bldg-label">Roof</span><span className="bldg-val">Gable &middot; Asphalt Shingle</span></div>
                <div className="bldg-row"><span className="bldg-label">Interiors</span><span className="bldg-val">Hardwood Floors</span></div>
              </div>
            </div>
            <div className="bldg-card" style={{ padding: '12px 14px', flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
  ...
  return (
    <div className="page">
      ...
      <div className="section--tight" style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        {/* Rows mirror the 300 Main I&E workbook exactly — labels, order, and
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: 6, tableLayout: 'fixed' }}>
          ...
          <tbody>
            {[
              ...
              ['Pet Fees', '$1,200', '$120', '—', '$1,200', '$120', '—', false],
              ['Additional Income', '$1,000', '$100', '—', '$1,000', '$100', '—', false],
              ['Total Additional Income', '$6,480', '$648', '—', '$6,480', '$648', '—', true],
            ].map(([label, ...cells], i) => {
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: 6, tableLayout: 'fixed' }}>
          ...
          <tbody>
            {[
              ...
              ['Water and Sewer', '$9,146', '$915', '—', '$9,146', '$915', '—'],
              ['Trash Removal', '$2,672', '$267', '—', '$2,672', '$267', '—'],
              ['Repairs and Maintenance', '$5,000', '$500', '—', '$5,000', '$500', '—'],
              ['Landscaping/Snow Removal', '$1,500', '$150', '—', '$1,500', '$150', '—'],
            ].map(([label, ...cells], i) => (
              <tr key={label} style={i % 2 === 1 ? { background: 'var(--linen)' } : undefined}>
      ...
      <div style={{ display: 'flex', flex: 1, minHeight: 0 }}>
        <div style={{ flex: '0 0 56%', padding: '28px 32px 24px 40px', display: 'flex', flexDirection: 'column', minHeight: 0 }}>
          ...
          <div style={{ fontSize: 10.5, lineHeight: 1.5, color: 'var(--graphite)', display: 'flex', flexDirection: 'column', gap: 9 }}>
            <p>
              ...
              immediately southwest of New Haven. The Allingtown neighborhood — where 300 Main Street sits — is
        ...
        <div style={{ flex: '0 0 44%', display: 'flex', flexDirection: 'column', gap: 4 }}>
          <div style={{ flex: 1, minHeight: 0, overflow: 'hidden' }}>
            <img src="/photos/main/main-5.jpg" alt="West Haven, CT — aerial" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
          </div>
          <div style={{ flex: 1, minHeight: 0, overflow: 'hidden' }}>
            <img src="/photos/main/main-3.jpg" alt="300 Main Street, West Haven" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
          </div>
        </div>
      </div>
      <PageFooter pageNum={pageNum} />
  ...
  return (
    <div className="page">
      ...
      <div style={{ display: 'flex', flex: 1, minHeight: 0 }}>
        ...
        <div style={{ flex: '0 0 45%', position: 'relative' }}><img src="/photos/main/main-8.jpg" alt="West Haven, CT" style={{ width: '100%', height: '100%', objectFit: 'cover' }} /></div>
      </div>
      <PageFooter pageNum={pageNum} />
    </div>
  )
