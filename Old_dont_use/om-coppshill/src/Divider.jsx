import { DEAL, FULL_ADDR } from './Shell.jsx'
...
/* ═══════════════════ SECTION DIVIDER ═══════════════════
   ...
   cover. Defaults to the deal cover image; pass `image` to swap per divider.
   TODO: set per-section divider imagery once photography is delivered.
*/
export default function Divider({
  eyebrow,
  title,
  image = DEAL.coverImage,
  pageNum,
}) {
  return (
    <div className="page">
