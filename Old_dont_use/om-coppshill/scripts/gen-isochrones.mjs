...
const SUBJECT = { lat: 41.2929, lon: -73.4942 } // Copps Hill Commons, 103 Danbury Rd, Ridgefield CT
const CONTOURS = [
...
const file = `/* AUTO-GENERATED by scripts/gen-isochrones.mjs (radial-envelope method) —
   do not hand-edit. Organic-but-clean drive-time rings from Copps Hill Commons,
   103 Danbury Rd, Ridgefield: raw Valhalla isochrone polygons (costing auto) resolved to one
