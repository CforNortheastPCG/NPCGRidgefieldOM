...
export default function LocationMap({ pageNum = 9 }) {
  const FULL_ADDR = '590–608 Campbell Avenue, West Haven, CT 06516'
    ...
    <div className="page">
      ...
      <div className="section--tight" style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
        ...
        <div style={{ fontSize: 11, lineHeight: 1.55, color: 'var(--graphite)', marginBottom: 12 }}>
          Set on Campbell Avenue in the heart of downtown West Haven, two blocks from the Green, the property sits
          minutes from the VA Connecticut medical campus (a mile up the same avenue), the University of New Haven,
          the West Haven Metro-North station, and the Savin Rock shoreline &mdash; with quick I-95 access to
          downtown New Haven and Yale.
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.15fr 1fr', gap: 16, flex: 1, minHeight: 0 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, minHeight: 0, overflow: 'hidden' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 9, paddingBottom: 10, borderBottom: '1px solid var(--border)' }}>
              ...
              <span style={{ fontSize: 12.5, fontWeight: 700, color: 'var(--carbon)' }}>Subject Property &mdash; 590&ndash;608 Campbell Avenue</span>
            </div>
      ...
      <div className="page-footer">
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <span className="conf">For Sale &middot; The Campbell Apartments &middot; 590&ndash;608 Campbell Avenue, West Haven, CT 06516</span>
        </div>
