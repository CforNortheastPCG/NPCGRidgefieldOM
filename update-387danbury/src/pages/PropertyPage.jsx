...
function Card({ title, rows, flex }) {
  return (
    <div className="bldg-card" style={{ padding: '9px 14px', flex, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
      <h3 style={{ fontSize: 11, marginBottom: 6, paddingBottom: 4 }}>{title}</h3>
