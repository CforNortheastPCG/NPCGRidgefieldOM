...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• OM PDF RENDERER (VECTOR) â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   ...
   as-is. One slide per sheet, sized 1:1 to the 816x1056px DOM page.
...
async function renderPdf({
  ...
  // Match the DOM page box exactly (816x1056px = 8.5in x 11in @96dpi).
  ...
  console.log(`Found ${count} pages · vector page.pdf() at 816x1056px`);
