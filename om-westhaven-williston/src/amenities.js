...
export const PROPERTY = {
  lat: 41.272038,
  lng: -72.951685,
  address: '711 Savin Avenue, West Haven, CT 06516',
}
...
export const DIRECTORY = [
  {
    ...
    items: [
      ...
      { name: 'The Breakwall', note: '305 Captain Thomas Blvd · Shoreline dining & live music · ~0.5 mi', address: 'The Breakwall, 305 Captain Thomas Blvd, West Haven, CT 06516' },
      { name: 'Saray Turkish Restaurant', note: '770 Campbell Ave · Acclaimed Turkish kitchen · ~1 mi', address: 'Saray Turkish Restaurant, 770 Campbell Ave, West Haven, CT 06516' },
      { name: "Georgie's Diner", note: '427 Elm St · Classic diner · ~0.7 mi', address: "Georgie's Diner, 427 Elm St, West Haven, CT 06516" },
    ],
  },
  {
