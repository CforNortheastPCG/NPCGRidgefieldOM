...
export function Toc({ pageNum }: { pageNum?: number }) {
  ...
  // Accent photo — an area shot, deliberately not the cover image (the
  // cover hero sits one page earlier). Falls back gracefully when the
  // book has no area photos.
  const accent = '/photos/toc-aerial.jpg'
