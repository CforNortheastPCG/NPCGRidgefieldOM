...
if (byTime) {
  ...
  if (args.includes('--coastal') || args.includes('--inland')) {
    coastal = args.includes('--coastal')
    console.log(`  geometry override (flag) → ${coastal ? 'COASTAL' : 'inland'}`)
  } else if (waterArcDeg != null) {
