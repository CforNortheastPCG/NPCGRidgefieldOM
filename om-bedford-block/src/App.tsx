...
import { RentRollDetail } from './components/pages/RentRollDetail.tsx'
import { UnitMixSummary } from './components/pages/UnitMixSummary.tsx'
import { FinancialSummary } from './components/pages/FinancialSummary.tsx'
import { CashFlow } from './components/pages/CashFlow.tsx'
import { T12Valuation } from './components/pages/T12Valuation.tsx'
...
import { CityOverview } from './components/pages/CityOverview.tsx'
import { CountyOverview } from './components/pages/CountyOverview.tsx'
import { LocationMap } from './components/pages/LocationMap.tsx'
import { DriveTimeMap } from './components/pages/DriveTimeMap.tsx'
import { RegionalMap } from './components/pages/RegionalMap.tsx'
...
function pageFor(entry: ManifestEntry, pageNum: number): ReactElement | null {
  switch (entry.type) {
    ...
    case 'rent-roll-detail':
      return <RentRollDetail pageNum={pageNum} />
    case 'unit-mix':
      return <UnitMixSummary pageNum={pageNum} />
    case 'financial-summary':
      return <FinancialSummary pageNum={pageNum} />
    case 'cash-flow':
      return <CashFlow pageNum={pageNum} />
    case 't12-valuation':
      return <T12Valuation pageNum={pageNum} />
    case 'tenant-profiles':
      return <TenantProfiles pageNum={pageNum} />
    case 'income-expense':
      return <IncomeExpense pageNum={pageNum} />
    case 'city-overview':
      return <CityOverview pageNum={pageNum} />
    case 'location-map':
      return <LocationMap pageNum={pageNum} />
    case 'drive-time-map':
      return <DriveTimeMap pageNum={pageNum} />
    case 'county-overview':
      return <CountyOverview pageNum={pageNum} />
    case 'regional-map':
      return <RegionalMap pageNum={pageNum} />
    case 'team':
