...
const TOC = [
  ...
  { n: 8, label: 'Property Overview', sub: true },
  { n: 9, label: 'Property Photos', sub: true },
  { n: 16, label: 'Unit Floor Plans', sub: true },
  { n: 17, label: 'Financial Analysis', section: true },
  { n: 18, label: 'Unit Mix & Rent Roll', sub: true },
  { n: 19, label: 'Income & Expense Analysis', sub: true },
  { n: 20, label: 'Location & Market', section: true },
  { n: 21, label: 'New Milford', sub: true },
  { n: 22, label: 'Location & Amenities', sub: true },
  { n: 23, label: 'Drive Times', sub: true },
  { n: 24, label: 'New Milford & Litchfield County', sub: true },
