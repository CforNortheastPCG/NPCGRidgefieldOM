...
const TOC = [
  ...
  { n: 8, label: 'Property Photos', sub: true },
  { n: 15, label: 'Unit Floor Plans', sub: true },
  ...
  { n: 19, label: 'Location & Market', section: true },
  { n: 20, label: 'New Milford', sub: true },
  { n: 21, label: 'Location & Amenities', sub: true },
  { n: 22, label: 'Drive Times', sub: true },
  { n: 23, label: 'New Milford & Litchfield County', sub: true },
  { n: 24, label: 'Regional Positioning', sub: true },
