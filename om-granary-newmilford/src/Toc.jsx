...
const TOC = [
  ...
  { n: 7, label: 'The Granary — Building History', sub: true },
  ...
  { n: 19, label: 'Trailing 12-Month & Forward NOI', sub: true },
  { n: 20, label: 'Location & Market', section: true },
  { n: 21, label: 'New Milford Green', sub: true },
  { n: 22, label: 'Why New Milford', sub: true },
  { n: 23, label: 'Litchfield County Living', sub: true },
  { n: 24, label: 'New Milford Aerials', sub: true },
  { n: 26, label: 'Location & Amenities', sub: true },
  { n: 27, label: 'Drive Times', sub: true },
  { n: 28, label: 'New Milford & Litchfield County', sub: true },
