...
const TOC = [
  ...
  { n: 16, label: 'Rent Roll & Lease-Up', sub: true },
  { n: 17, label: 'Income & Expense', sub: true },
  { n: 18, label: 'Location & Market', section: true },
  { n: 19, label: 'City Overview', sub: true },
  { n: 20, label: 'Location & Amenities', sub: true },
  { n: 21, label: 'Drive Times', sub: true },
  { n: 22, label: 'County Overview & Employment', sub: true },
  { n: 23, label: 'Regional Positioning', sub: true },
  { n: 24, label: 'The Team', section: true },
