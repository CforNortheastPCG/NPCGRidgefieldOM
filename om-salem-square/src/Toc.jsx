...
const TOC = [
  ...
  { n: 17, label: 'Rent Roll & Lease-Up', sub: true },
  { n: 18, label: 'Income & Expense', sub: true },
  { n: 19, label: 'Location & Market', section: true },
  { n: 20, label: 'City Overview', sub: true },
  { n: 21, label: 'Location & Amenities', sub: true },
  { n: 22, label: 'Drive Times', sub: true },
  { n: 23, label: 'County Overview & Employment', sub: true },
